...
{
    public class CurrencyCalculatorLayout : CalcLayout
    {
        public CurrencyCalculatorLayout()
        {
            ...
            RegisterTextBox(new CalculatorTextBox("ioBox", new Point(65, 15), new Size(255, 45)));
            var currencyFrom = new CalculatorTextBox("currencyFrom", new Point(15, 15), new Size(45, 20));
            currencyFrom.GetControl().Text = "1";
            RegisterTextBox(currencyFrom);
            var currencyTo = new CalculatorTextBox("currencyTo", new Point(15, 40), new Size(45, 20));
            currencyTo.GetControl().Text = "1";
            RegisterTextBox(currencyTo);
        }
    }
}